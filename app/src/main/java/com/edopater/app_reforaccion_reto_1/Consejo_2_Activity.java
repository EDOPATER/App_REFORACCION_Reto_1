...
public class Consejo_2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Enlaza el TextView
        TextView consejoTextView = findViewById(R.id.Consejo2);

        // Asigna un texto al TextView
        consejoTextView.setText("o\to\tCalidad de las plántulas: Utiliza plántulas sanas y de calidad, preferiblemente de viveros certificados.\n\n" +
                "o\to\tManejo cuidadoso: Manipula las plántulas con cuidado para evitar daños a las raíces y al sistema de la planta.\n\n");

        String text = "o\tCalidad de las plántulas: Utiliza plántulas sanas y de calidad, preferiblemente de viveros certificados.\n\n" +
                "o\tManejo cuidadoso: Manipula las plántulas con cuidado para evitar daños a las raíces y al sistema de la planta.\n\n";

        SpannableString spannableString = new SpannableString(text);

        String boldText1 = "Calidad de las plántulas:";
        String boldText2 = "Manejo cuidadoso:";
        ...
        A_Consejos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v){
                Intent back = new Intent(Consejo_2_Activity.this, ConsejosActivity.class);
                startActivity(back);
            }
        });
