...
public class Consejo_6_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Enlaza el TextView
        TextView consejoTextView = findViewById(R.id.Consejo6);

        // Asigna un texto al TextView
        consejoTextView.setText("o\tMonitoreo regular: Inspecciona regularmente los árboles para detectar signos de plagas y enfermedades.\n\n" +
                "o\tTratamiento temprano: Toma medidas rápidas para controlar y tratar plagas y enfermedades tan pronto como se detecten.\n\n");

        String text = "o\tMonitoreo regular: Inspecciona regularmente los árboles para detectar signos de plagas y enfermedades.\n\n" +
                "o\tTratamiento temprano: Toma medidas rápidas para controlar y tratar plagas y enfermedades tan pronto como se detecten.\n\n";

        SpannableString spannableString = new SpannableString(text);

        String boldText1 = "Monitoreo regular:";
        String boldText2 = "Tratamiento temprano:";
        ...
        A_Consejos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v){
                Intent back = new Intent(Consejo_6_Activity.this, ConsejosActivity.class);
                startActivity(back);
            }
        });
