...
public class Informacion_6_Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informacion6);
        ...
        A_Informacion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(Informacion_6_Activity.this, InformacionAmbActivity.class);
                startActivity(back);
            }
        });
    }
