...
public class Informacion_5_Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informacion5);
        ...
        A_Informacion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(Informacion_5_Activity.this, InformacionAmbActivity.class);
                startActivity(back);
            }
        });
    }
